...
jQuery(function ($) {
    ...
    // 1. fixed navbar
		...
		$('.main_lang .dropdown').click(function(){
			$(this).toggleClass('show');
			$('.main_lang .dropdown > .dropdown-menu').toggle();
		});
	$(window).resize(function(){
		...
		$('.main_lang .dropdown > .dropdown-menu').hide();
		$('.main_lang .dropdown').removeClass('show');
	});
